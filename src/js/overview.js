...
function request (isRunning) {
    ...
    if (isRunning) {
        ...
        connection.createRequest('getBalance', {}, function(response) {
            ...
            availableBalance.innerHTML = (result['availableBalance'] / 100000000).toFixed(8)
            lockedBalance.innerHTML = (result['lockedAmount'] / 100000000).toFixed(8)
        })
        ...
        availableBalance.innerHTML = (0).toFixed(8)
        lockedBalance.innerHTML = (0).toFixed(8)
